...
object HandKeyMap {
    ...
    private val RIGHT_HAND_CHARS: Set<Char> = setOf(
        'ক', 'খ', 'ত', 'থ', 'দ', 'ধ', 'ব', 'ভ', 'ন', 'ণ',
        'স', 'ষ', 'ম', 'শ', 'চ', 'ছ', 'জ', 'ঝ', 'ঞ', 'হ',
        'গ', 'ঘ', '\u09DC', '\u09DD',  // ড়, ঢ় — precomposed escape ব্যবহার করা হয়েছে কারণ
                                        // কপি-পেস্ট করা 'ড়'/'ঢ়' আসলে ২-কোডপয়েন্টের decomposed
                                        // sequence (base+nukta), যা একটা Char literal-এ ধরে না
        ';', '\'', 'ৎ', 'ঃ', 'ঁ',
        ',', '।', '.', '/',
        '(', ')', '[', ']', '{', '}'
    )
