...
object HandKeyMap {
    ...
    private val RIGHT_HAND_CHARS: Set<Char> = setOf(
        ...
        'স', 'ষ', 'ম', 'শ', 'চ', 'ছ', 'জ', 'ঝ', 'ঞ', 'হ',
        'গ', 'ঘ',
        // ড়, ঢ়, য় — precomposed একক কোডপয়েন্ট হিসেবে (normalizeBn() এখন সবসময়
        // base+nukta জোড়া লাগিয়ে এই ফর্মেই আনে, দেখো TypingPracticeScreen.kt) —
        // ড়/ঢ় ডেভেলপার তার আসল কীবোর্ড থেকে verified, য় পাশের কী হিসেবে ধরে নেওয়া হলো
        '\u09DC', '\u09DD', '\u09DF',
        ';', '\'', 'ৎ', 'ঃ', 'ঁ',
        ',', '।', '.', '/',
        '(', ')', '[', ']', '{', '}'
